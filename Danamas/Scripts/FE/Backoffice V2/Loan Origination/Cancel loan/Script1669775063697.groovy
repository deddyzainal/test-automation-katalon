...
//Select CANCEL in dropdown
WebUI.click(findTestObject('FE/Backoffice V2/Loan Origination/Detail/Select - Tipe Cancel'), FailureHandling.STOP_ON_FAILURE)
WebUI.click(findTestObject('FE/Backoffice V2/Loan Origination/Detail/Select - Option', [('option') : 'Cancel']), FailureHandling.STOP_ON_FAILURE)
...
//Verify status in detail page is 'CANCELLED'
WebUI.verifyElementText(findTestObject('FE/Backoffice V2/Loan Origination/Detail/TextValue - Status'), 'CANCELLED', FailureHandling.STOP_ON_FAILURE)