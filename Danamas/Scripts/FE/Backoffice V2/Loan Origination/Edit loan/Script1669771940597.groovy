...
//Click button Ubah
WebUI.click(findTestObject('FE/Backoffice V2/Loan Origination/Detail/Button - Ubah Loan'), FailureHandling.STOP_ON_FAILURE)
WebUI.waitForElementVisible(findTestObject('FE/Backoffice V2/Loan Origination/Form/Input - Jumlah Pinjaman'), 3, FailureHandling.STOP_ON_FAILURE)
