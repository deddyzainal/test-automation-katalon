...
//Click button Tambah Jenis Pinjaman
WebUI.click(findTestObject('FE/Backoffice V2/Loan Type/List/Button - Tambah Jenis Pinjaman'), FailureHandling.STOP_ON_FAILURE)
