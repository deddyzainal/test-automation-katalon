...
//Click button Buat Template Baru
WebUI.click(findTestObject('FE/Backoffice/Audience List/List/Button - Buat Template Baru'))
...
WebUI.verifyElementText(findTestObject('FE/Backoffice/Common/Snackbar - Heading'), 'Audience berhasil dibuat!', FailureHandling.STOP_ON_FAILURE)