...
WebUI.callTestCase(findTestCase('FE/Backoffice/Audience List/List/Filter by Nama Audien'), null, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('FE/Backoffice/Audience List/List/Reset filter'), null, FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('FE/Backoffice/Audience List/List/Sort by Nama Audien'), null, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('FE/Backoffice/Audience List/List/Sort by Update Terkini'), null, FailureHandling.CONTINUE_ON_FAILURE)
