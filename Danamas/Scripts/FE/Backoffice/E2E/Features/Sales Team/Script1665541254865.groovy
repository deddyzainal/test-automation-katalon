...
WebUI.callTestCase(findTestCase('FE/Backoffice/Sales/Sales Team/List/Filter list by Nama'), null, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.refresh()

WebUI.callTestCase(findTestCase('FE/Backoffice/Sales/Sales Team/List/Filter list by Nama Cabang'), null, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('FE/Backoffice/Sales/Sales Team/List/Filter list by Posisi'), null, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.refresh()

WebUI.callTestCase(findTestCase('FE/Backoffice/Sales/Sales Team/List/Filter list by Cabang Partner'), null, FailureHandling.CONTINUE_ON_FAILURE)
