...
//Click button Tambah Lokasi
WebUI.scrollToElement(findTestObject('FE/Backoffice/List KJPP/Detail/Lokasi/Button - Tambah Lokasi'), 3)
WebUI.click(findTestObject('FE/Backoffice/List KJPP/Detail/Lokasi/Button - Tambah Lokasi'))
...
//Click button Simpan
WebUI.click(findTestObject('FE/Backoffice/List KJPP/Detail/Lokasi/Button - Tambah'))
...
WebUI.verifyElementText(findTestObject('FE/Backoffice/Common/Snackbar - Subheading'), 'Berhasil menambah lokasi', FailureHandling.STOP_ON_FAILURE)