...
WebUI.click(findTestObject('FE/Backoffice/List KJPP/Detail/Properti/Button - Edit'))
...
//Click button Simpan
WebUI.click(findTestObject('FE/Backoffice/List KJPP/Detail/Properti/Button - Simpan'))
...
WebUI.verifyElementText(findTestObject('FE/Backoffice/Common/Snackbar - Subheading'), 'Berhasil mengedit properti', FailureHandling.STOP_ON_FAILURE)