...
WebUI.scrollToElement(findTestObject('FE/Backoffice/Loan Origination/Detail/Button - Lihat Semua Data'), 2)
WebUI.click(findTestObject('FE/Backoffice/Loan Origination/Detail/Button - Lihat Semua Data'))
