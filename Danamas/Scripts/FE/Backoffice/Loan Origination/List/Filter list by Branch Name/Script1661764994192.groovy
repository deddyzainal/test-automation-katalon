...
WebUI.waitForElementVisible(findTestObject('FE/Backoffice/Loan Origination/List/Select - Branch Name'), 3)
WebUI.click(findTestObject('FE/Backoffice/Loan Origination/List/Select - Branch Name'))
