...
WebUI.callTestCase(findTestCase('FE/Backoffice/Telesales/Filter list by Nama Peminjam'), [('nama_peminjam') : 'Pink'], FailureHandling.STOP_ON_FAILURE)

WebUI.refresh()

WebUI.callTestCase(findTestCase('FE/Backoffice/Telesales/Filter list by Kategori'), [('kategori') : 'RESUBMISSION'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('FE/Backoffice/Telesales/Upload file'), [('object') : 'FE/Backoffice/Telesales/Edit/Dokumen Agunan/Input - Foto PBB Baru'
        , ('file') : '/Users/meitridelfiza/Documents/file.png'], FailureHandling.STOP_ON_FAILURE)
