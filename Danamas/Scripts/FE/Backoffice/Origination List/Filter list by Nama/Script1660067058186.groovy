...
CustomKeywords.'backoffice.common.setTextWithDelay'(findTestObject('FE/Backoffice/Origination List/Input - Nama'),
	nama_peminjam)

//Verify name in the list contains inputted text
WebUI.waitForPageLoad(5)
WebUI.verifyMatch(WebUI.getText(findTestObject('FE/Backoffice/Origination List/TextValue - Nama Peminjam')).toUpperCase(), ".*$nama_peminjam.*".toUpperCase(), true)
