...
WebUI.waitForElementVisible(findTestObject('FE/Backoffice/Origination List/Dropdown - Tipe Agent'), 3)
WebUI.click(findTestObject('FE/Backoffice/Origination List/Dropdown - Tipe Agent'))
