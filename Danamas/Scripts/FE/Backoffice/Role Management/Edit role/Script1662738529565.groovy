...
WebUI.scrollToElement(findTestObject('FE/Backoffice/Role Management/Detail/Button - Ubah Informasi'), 3)
WebUI.click(findTestObject('FE/Backoffice/Role Management/Detail/Button - Ubah Informasi'))
