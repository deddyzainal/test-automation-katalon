...
//Click button Tambah Branch
WebUI.click(findTestObject('FE/Backoffice/Sales/Branch/List/Button - Tambah Branch'))
...
//Click button Tambah Branch Baru
WebUI.click(findTestObject('FE/Backoffice/Sales/Branch/Form/Button - Tambah Branch Baru'))
