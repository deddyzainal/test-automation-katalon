...
WebUI.click(findTestObject('FE/Backoffice/Sales/Partner/Detail/Button - Ubah Informasi'))
...
//Click button Simpan
WebUI.scrollToElement(findTestObject('FE/Backoffice/Sales/Partner/Form/Button - Simpan'), 2)
WebUI.click(findTestObject('FE/Backoffice/Sales/Partner/Form/Button - Simpan'))
...
WebUI.waitForElementVisible(findTestObject('FE/Backoffice/Sales/Partner/Form/Snackbar - Heading'), 5, FailureHandling.STOP_ON_FAILURE)
WebUI.verifyElementText(findTestObject('FE/Backoffice/Sales/Partner/Form/Snackbar - Heading'), 'Informasi Partner berhasil diubah', FailureHandling.STOP_ON_FAILURE)
