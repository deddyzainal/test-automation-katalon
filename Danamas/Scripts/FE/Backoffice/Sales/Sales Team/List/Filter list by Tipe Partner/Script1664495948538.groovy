...
WebUI.callTestCase(findTestCase('FE/Backoffice/Sales/Sales Team/List/Filter list by Kategori Agen'), [('kategori_agen') : 'Partner'], FailureHandling.STOP_ON_FAILURE)

//Click dropdown Tipe Partner
WebUI.waitForElementVisible(findTestObject('FE/Backoffice/Sales/Sales Team/List/Select - Tipe Partner'), 3, FailureHandling.STOP_ON_FAILURE)
WebUI.click(findTestObject('FE/Backoffice/Sales/Sales Team/List/Select - Tipe Partner'))
