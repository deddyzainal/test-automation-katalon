...
WebUI.waitForElementVisible(findTestObject('FE/Backoffice/Navigation Bar/Menu - Loan Assessment'), 3)
WebUI.click(findTestObject('FE/Backoffice/Navigation Bar/Menu - Loan Assessment'))
