...
WebUI.waitForElementVisible(findTestObject('FE/Backoffice/Side Menu/Menu - Loan Origination'), 3)
WebUI.click(findTestObject('FE/Backoffice/Side Menu/Menu - Loan Origination'))
