...
WebUI.waitForElementVisible(findTestObject('FE/Backoffice/Side Menu/Menu - Offer Letter'), 3)
WebUI.click(findTestObject('FE/Backoffice/Side Menu/Menu - Offer Letter'))
