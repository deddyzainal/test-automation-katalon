...
WebUI.click(findTestObject('FE/Backoffice/Telesales/List/Option - Pilih Tanggal Sendiri'))

//Select From date and To date
WebUI.click(findTestObject('FE/Backoffice/Telesales/List/Date - From'))
WebUI.click(findTestObject('FE/Backoffice/Telesales/List/Date - To'))
