...
if (WebUI.verifyElementPresent(findTestObject(object), 2, FailureHandling.OPTIONAL)) {
    ...
    WebUI.waitForElementNotPresent(findTestObject(object), 5, FailureHandling.STOP_ON_FAILURE)
}
