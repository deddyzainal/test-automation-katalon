...
Mobile.tap(findTestObject('FE/Danamas/Android/Borrower/ProfilPage/Menu - Bantuan'), 3)

Mobile.verifyElementVisible(findTestObject('FE/Danamas/Android/Borrower/MiscPage/Header - Bantuan'), 3)
