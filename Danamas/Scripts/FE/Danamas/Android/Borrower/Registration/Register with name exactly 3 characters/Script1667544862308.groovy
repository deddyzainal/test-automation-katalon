...
Mobile.setText(findTestObject('FE/Danamas/Android/Borrower/RegisterPage/Input - Nama'), 'Qwe', 3)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('FE/Danamas/Android/Borrower/RegisterPage/Input - Alamat email'), 3)

Mobile.verifyElementNotExist(findTestObject('FE/Danamas/Android/Borrower/RegisterPage/Error - Nama minimal'), 3)
