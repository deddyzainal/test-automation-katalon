...
Mobile.tap(findTestObject('FE/Danamas/Android/ProfilPage/Menu - Syarat Ketentuan'), 3)

Mobile.verifyElementVisible(findTestObject('FE/Danamas/Android/BorrowerMiscPage/Header - Syarat dan Ketentuan'), 3)
