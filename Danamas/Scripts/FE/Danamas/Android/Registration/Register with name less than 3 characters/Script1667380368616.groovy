...
Mobile.setText(findTestObject('FE/Danamas/Android/BorrowerRegisterPage/Input - Nama'), 'Qw', 3)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('FE/Danamas/Android/BorrowerRegisterPage/Input - Alamat email'), 3)

Mobile.verifyElementVisible(findTestObject('FE/Danamas/Android/BorrowerRegisterPage/Error - Nama minimal'), 3)
