...
Mobile.setText(findTestObject('FE/Danamas/Android/BorrowerRegisterPage/Input - Nomor Handphone'), '1234567', 3)
...
Mobile.verifyElementVisible(findTestObject('FE/Danamas/Android/BorrowerRegisterPage/Error - Nomor Handphone tidak sesuai'), 3)
