...
Mobile.setText(findTestObject('FE/LancarMobile/Android/Login/Input - Kata Sandi'), 'Password2', 2)
Mobile.hideKeyboard()

Mobile.tap(findTestObject('FE/LancarMobile/Android/Login/Button - MASUK (Login)'), 2)

Mobile.verifyElementVisible(findTestObject('FE/LancarMobile/Android/Home/Button - Profile'), 10)