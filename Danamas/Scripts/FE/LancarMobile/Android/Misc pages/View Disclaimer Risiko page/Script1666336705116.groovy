...
Mobile.tap(findTestObject('FE/LancarMobile/Android/Home/Button - Disclaimer Risiko Menu'), 5)

Mobile.verifyElementVisible(findTestObject('FE/LancarMobile/Android/Misc pages/Header - Disclaimer Risiko'), 10)
