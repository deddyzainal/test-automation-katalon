...
Mobile.tap(findTestObject('FE/LancarMobile/Android/Home/Button - Hubungi Kami Menu'), 5)

Mobile.verifyElementVisible(findTestObject('FE/LancarMobile/Android/Misc pages/Header - Bicara dengan kami'), 10)
