...
Mobile.tap(findTestObject('FE/LancarMobile/Android/Home/Button - Kebijakan Privasi Menu'), 5)

Mobile.verifyElementVisible(findTestObject('FE/LancarMobile/Android/Misc pages/Header - Ketentuan Umum'), 10)
