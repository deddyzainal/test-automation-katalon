...
Mobile.tap(findTestObject('FE/LancarMobile/Android/Register/Input - Alamat Email'), 2)
Mobile.setText(findTestObject('FE/LancarMobile/Android/Register/Input - Alamat Email'), timestamp + "@mailinator.com", 2)
Mobile.hideKeyboard()
...
Mobile.setText(findTestObject('FE/LancarMobile/Android/Register/Input - Konfirmasi Kata Sandi'), 'Password2', 2)
Mobile.hideKeyboard()

Mobile.scrollToText('Sudah punya akun Lancar?')
...
Mobile.verifyElementVisible(findTestObject('FE/LancarMobile/Android/Register/Error - Mismatched Password Confirmation'), 1)