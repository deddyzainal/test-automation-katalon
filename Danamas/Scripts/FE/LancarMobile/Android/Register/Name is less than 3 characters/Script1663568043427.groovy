...
Mobile.setText(findTestObject('FE/LancarMobile/Android/Register/Input - Nama'), 'Ba', 2)
Mobile.hideKeyboard()

Mobile.tap(findTestObject('FE/LancarMobile/Android/Register/Input - Nomor Telepon'), 2)
Mobile.verifyElementVisible(findTestObject('FE/LancarMobile/Android/Register/Error - Minimum Name Length'), 2)