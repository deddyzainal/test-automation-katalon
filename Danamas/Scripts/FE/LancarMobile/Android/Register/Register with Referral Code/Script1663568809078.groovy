...
Mobile.setText(findTestObject('FE/LancarMobile/Android/Register/Input - Kode Referral'), referralCode, 2)
Mobile.hideKeyboard()
...
Mobile.verifyElementVisible(findTestObject('FE/LancarMobile/Android/Register/Input - OTP'), 20)