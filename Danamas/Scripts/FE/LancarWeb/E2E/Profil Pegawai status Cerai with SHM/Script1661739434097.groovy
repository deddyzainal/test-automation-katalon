...
WebUI.callTestCase(findTestCase('FE/LancarWeb/Upload KTP/Complete KTP data'), [('namaKTP') : 'Debby Anggraini', ('NIK') : '3174096112900001'
        ...
        , ('tempatLahir') : 'Jakarta Barat', ('statusPerkawinan') : 'Cerai Hidup', ('pendidikan') : 'Sarjana', ('alamat') : 'Jl. Pasar Kembang no. 7'
...
WebUI.callTestCase(findTestCase('FE/LancarWeb/Unggah Dokumen/Upload Akta Cerai or Surat Kematian'), [('aktaCeraiFilepath') : '/Users/garahandhito/Danamas/qa-automation/Danamas/Data Files/LancarWeb/akta-cerai.jpeg'], 
    FailureHandling.STOP_ON_FAILURE)
