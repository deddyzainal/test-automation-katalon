...
// Select BPKB Motor and SHM as Jenis Sertifikat
...
// Verify popup with option to proses with SHM or both SHM & BPKB
WebUI.waitForElementVisible(findTestObject('FE/LancarWeb/Profil Kustomer/Text - Proses Sertifikat Properti'), 2)
WebUI.waitForElementVisible(findTestObject('FE/LancarWeb/Profil Kustomer/Text - Proses Sertifikat Properti dan BPKB'), 2)
WebUI.click(findTestObject('FE/LancarWeb/Profil Kustomer/Text - Proses Sertifikat Properti dan BPKB'))
