...
WebUI.waitForElementVisible(findTestObject('FE/LancarWeb/Register/Input - Nomor Telepon'), 5)
WebUI.click(findTestObject('FE/LancarWeb/Register/Input - Nomor Telepon'))
WebUI.sendKeys(findTestObject('FE/LancarWeb/Register/Input - Nomor Telepon'), '1234567')

WebUI.click(findTestObject('FE/LancarWeb/Register/Input - Alamat Email'))
WebUI.verifyElementVisible(findTestObject('FE/LancarWeb/Register/Text - Invalid Phone Number Error'))