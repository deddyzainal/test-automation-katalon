...
WebUI.sendKeys(findTestObject('FE/LancarWeb/Simulasi Pinjaman/Input - Nilai Minimum Properti'), 2500)
...
WebUI.sendKeys(findTestObject('FE/LancarWeb/Simulasi Pinjaman/Input - Nilai Pinjaman'), 250)

// Get value of Pembayaran Bulanan
String pembayaranAwal = WebUI.getText(findTestObject('FE/LancarWeb/Simulasi Pinjaman/TextValue - Pembayaran Bulanan')).toInteger()
...
WebUI.sendKeys(findTestObject('FE/LancarWeb/Simulasi Pinjaman/Input - Tenor'), 10)

// Compare value of Pembayaran Bulanan after Tenor set to maximum
String pembayaranBaru = WebUI.getText(findTestObject('FE/LancarWeb/Simulasi Pinjaman/TextValue - Pembayaran Bulanan')).toInteger()
WebUI.verifyGreaterThan(pembayaranAwal, pembayaranBaru)
...
WebUI.verifyElementNotPresent(findTestObject('FE/LancarWeb/Simulasi Pinjaman/Button - SETUJU, SELANJUTNYA'), 5)