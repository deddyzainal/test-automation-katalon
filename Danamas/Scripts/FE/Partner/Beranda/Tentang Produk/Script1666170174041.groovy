...
if (WebUI.click(findTestObject('Object Repository/FE/PARTNER/Beranda/img_pinjamanberagunan'))) {
	WebUI.click(findTestObject('Object Repository/FE/PARTNER/Beranda/img_pinjamanberagunan'))

	
	}else if(WebUI.click(findTestObject('FE/PARTNER/Beranda/img_danaexpress'))){
