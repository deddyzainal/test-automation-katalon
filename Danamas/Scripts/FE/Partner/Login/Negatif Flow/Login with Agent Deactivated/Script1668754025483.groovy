...
WebUI.callTestCase(findTestCase('FE/Partner/Login/Login with credential'), [('nomorhp') : '20221115155021', ('katasandi') : GlobalVariable.password], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent('Akun anda telah dinonaktifkan. Mohon hubungi Customer Service', false)
