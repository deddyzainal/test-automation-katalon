...
WebUI.click(findTestObject('FE/PARTNER/Profil/Kode Referral'))

WebUI.waitForElementVisible(findTestObject('FE/PARTNER/Profil/Menu - Kode Referral'), 3)

WebUI.click(findTestObject('FE/PARTNER/Profil/Copy - Kode Referral'))

WebUI.verifyTextPresent('Disalin ke papan klip', false)
