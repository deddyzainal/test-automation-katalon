...
WebUI.click(findTestObject('FE/PARTNER/Profil/Informasi Pribadi'))

WebUI.waitForElementVisible(findTestObject('FE/PARTNER/Profil/Informasi Pribadi'), 3)

WebUI.verifyElementVisible(findTestObject('FE/PARTNER/Profil/Informasi Pribadi2'))
