...
WebUI.callTestCase(findTestCase('FE/Partner/Beranda/List/Input Data/Input Data - Informasi Peminjam'), [('gender') : 'Laki-laki', ('tempatlahir') : 'jakarta'
        , ('nama') : 'test11', ('pendidikan') : 'Sarjana', ('statusPerkawinan') : 'Kawin', ('date1') : '10-Agustus', ('eYear') : '1999'
        , ('nikpasangan') : '1312213121111123', ('date2') : '15-Agustus', ('namapasangan') : 'Joko'], FailureHandling.STOP_ON_FAILURE)
