...
if (Agen.toLowerCase() == 'branch') {
    ...
    WebUI.callTestCase(findTestCase('FE/Partner/Register/List/Input Data/Input data Agen Branch'), [('kota') : 'Bangli', ('cabang') : 'test'
    ...
    WebUI.callTestCase(findTestCase('FE/Partner/Register/List/Input Data/Input data Agen Partner'), [('type') : 'external', ('namapartner') : 'Freelance HO'
            , ('kodereferral') : Referral_RM], FailureHandling.STOP_ON_FAILURE)
}
...
WebUI.verifyElementVisible(findTestObject('FE/PARTNER/Register/input_passwordbaru'), FailureHandling.STOP_ON_FAILURE)
