...
WebUI.callTestCase(findTestCase('FE/Partner/Register/Detail/Register/Register User AS Branch - Branch Manager'), [('Agen') : 'branch', ('timestamp1') : GlobalVariable.timestamp], 
