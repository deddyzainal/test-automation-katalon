...
if (Agen.toLowerCase() == 'branch') {
    ...
    WebUI.callTestCase(findTestCase('FE/Partner/Register/List/Input Data/Input data Agen Branch'), [('kota') : 'Bandung', ('cabang') : 'Danamas Bandung'
            , ('posisi') : 'Branch Manager'], FailureHandling.STOP_ON_FAILURE //tipe partner
        //nama partner
        )
    ...
    WebUI.callTestCase(findTestCase('FE/Partner/Register/List/Input Data/Input data Agen Partner'), [('type') : type, ('namapartner') : namapartner
            , ('kodereferral') : 'B063011190'], FailureHandling.STOP_ON_FAILURE)
}
