...
WebUI.sendKeys(findTestObject('FE/PARTNER/Register/input_Nomor HP'), timestamp1)
...
WebUI.sendKeys(findTestObject('FE/PARTNER/Register/input_OTP_1'), timestamp1.substring(8))
...
WebUI.sendKeys(findTestObject('FE/PARTNER/Register/input_NIK'), timestamp1 + 12)
...
WebUI.sendKeys(findTestObject('FE/PARTNER/Register/input_NPWP'), timestamp1 + 1)
...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/Register/input_Masukkan Fax'), 2)

WebUI.click(findTestObject('FE/PARTNER/Register/input_Masukkan Fax'))

WebUI.clearText(findTestObject('FE/PARTNER/Register/input_Masukkan Fax'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('FE/PARTNER/Register/input_Masukkan Fax'), fax)
