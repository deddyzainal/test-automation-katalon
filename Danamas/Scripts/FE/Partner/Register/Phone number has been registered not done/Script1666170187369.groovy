...
WebUI.sendKeys(findTestObject('FE/PARTNER/Register/input_Nomor HP'), GlobalVariable.nohp)

WebUI.click(findTestObject('FE/PARTNER/Register/button_Lanjut'))

WebUI.verifyElementVisible(findTestObject('FE/PARTNER/Register/text - Nomor HP telah terdaftar'))
