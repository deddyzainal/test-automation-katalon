...
WebUI.sendKeys(findTestObject('FE/PARTNER/Register/input_Nomor HP'), '1234567')

WebUI.click(findTestObject('FE/PARTNER/Register/button_Lanjut'))

WebUI.verifyElementVisible(findTestObject('FE/PARTNER/Register/text - invalid phone number'))
