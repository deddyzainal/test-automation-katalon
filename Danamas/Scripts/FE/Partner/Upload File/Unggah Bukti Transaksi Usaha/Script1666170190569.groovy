...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Bukti Transaksi Usaha'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/Unggah Bukti Transaksi Usaha'))

WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Bukti Transaksi Usaha'), 2)

File file1 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file2 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file3 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file4 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file5 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file6 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file7 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file8 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file9 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file10 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file11 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file12 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file13 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file14 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
File file15 = new File('Data Files/PartnerWeb/bukti_transaksi.jpeg')
...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Bukti Transaksi Usaha'), 5)
