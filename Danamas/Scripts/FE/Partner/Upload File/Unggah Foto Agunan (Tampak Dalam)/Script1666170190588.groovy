...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Foto Agunan (Tampak Dalam)'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/Unggah Foto Agunan (Tampak Dalam)'))

WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Foto Agunan (Tampak Dalam)'), 2)

if(WebUI.verifyElementPresent(findTestObject('FE/PARTNER/upload/Cara Unggah'), 2, FailureHandling.OPTIONAL)) {
WebUI.callTestCase(findTestCase('FE/Partner/Upload File/Cara Unggah'), [:], FailureHandling.OPTIONAL)
}

File file1 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file2 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file3 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file4 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file5 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file6 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file7 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file8 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file9 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file10 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file11 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file12 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file13 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file14 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')

File file15 = new File('Data Files/PartnerWeb/tampak_dalam.jpeg')
...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Foto Agunan (Tampak Dalam)'), 5)
