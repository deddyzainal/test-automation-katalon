...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/unggah_Foto Buku Nikah'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/unggah_Foto Buku Nikah'))

WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/unggah_Foto Buku Nikah'), 2)

File file1 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file2 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file3 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file4 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file5 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file6 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file7 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file8 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file9 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file10 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file11 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file12 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file13 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file14 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
File file15 = new File('Data Files/PartnerWeb/buku-nikah.jpeg')
...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Foto PBB'), 5)
