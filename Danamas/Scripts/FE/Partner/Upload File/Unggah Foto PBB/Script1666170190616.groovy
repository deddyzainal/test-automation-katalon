...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Foto PBB'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/Unggah Foto PBB'))
...
File file2 = new File('Data Files/PartnerWeb/pbb.jpeg')
