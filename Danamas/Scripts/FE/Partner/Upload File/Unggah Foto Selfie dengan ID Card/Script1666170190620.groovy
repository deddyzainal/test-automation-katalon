...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Foto Selfie dengan ID Card'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/Unggah Foto Selfie dengan ID Card'))
...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Foto Selfie dengan ID Card'), 5)
