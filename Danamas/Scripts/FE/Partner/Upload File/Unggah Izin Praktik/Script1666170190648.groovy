...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Izin Praktik'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/Unggah Izin Praktik'))
...
File file1 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file2 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file3 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file4 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file5 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file6 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file7 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file8 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file9 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file10 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file11 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file12 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file13 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file14 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')

File file15 = new File('Data Files/PartnerWeb/izin_praktik.jpeg')
...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Izin Praktik'), 5)
