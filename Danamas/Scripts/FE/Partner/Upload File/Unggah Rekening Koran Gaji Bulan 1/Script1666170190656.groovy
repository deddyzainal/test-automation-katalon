...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Gaji Bulan 1'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Gaji Bulan 1'))
...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Gaji Bulan 1'), 5)
