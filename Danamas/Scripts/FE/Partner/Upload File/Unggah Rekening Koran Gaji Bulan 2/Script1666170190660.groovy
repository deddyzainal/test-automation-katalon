...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Gaji Bulan 2'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Gaji Bulan 2'))
...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Gaji Bulan 2'), 5)
