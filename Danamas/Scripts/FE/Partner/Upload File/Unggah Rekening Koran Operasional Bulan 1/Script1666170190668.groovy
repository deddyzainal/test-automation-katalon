...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Operasional Bulan 1'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Operasional Bulan 1'))

WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Operasional Bulan 1'), 2)

File file1 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file2 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file3 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file4 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file5 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file6 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file7 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file8 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file9 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file10 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file11 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file12 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file13 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file14 = new File('Data Files/PartnerWeb/rek_koran.pdf')
File file15 = new File('Data Files/PartnerWeb/rek_koran.pdf')
...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Operasional Bulan 1'), 5)
