...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Operasional Bulan 3'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Operasional Bulan 3'))
...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Rekening Koran Operasional Bulan 3'), 5)
