...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Slip Gaji or SPT'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/Unggah Slip Gaji or SPT'))

WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Slip Gaji or SPT'), 2)

File file1 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file2 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file3 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file4 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file5 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file6 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file7 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file8 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file9 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file10 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file11 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file12 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file13 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file14 = new File('Data Files/PartnerWeb/slipgaji.pdf')
File file15 = new File('Data Files/PartnerWeb/slipgaji.pdf')
...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/Unggah Slip Gaji or SPT'), 5)
