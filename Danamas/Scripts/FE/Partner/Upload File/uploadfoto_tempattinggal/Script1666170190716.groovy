...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/unggah_Foto tempat tinggal saat ini'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/unggah_Foto tempat tinggal saat ini'))
...
File file1 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file2 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file3 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file4 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file5 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file6 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file7 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file8 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file9 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file10 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file11 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file12 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file13 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file14 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')

File file15 = new File('Data Files/PartnerWeb/tempat_tinggal.jpeg')
...
WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/unggah_Foto tempat tinggal saat ini'), 5)
