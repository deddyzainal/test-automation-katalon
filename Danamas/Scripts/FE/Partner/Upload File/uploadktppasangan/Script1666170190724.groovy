...
WebUI.scrollToElement(findTestObject('FE/PARTNER/upload/unggah_Foto KTP Pasangan'), 2)

WebUI.waitForElementVisible(findTestObject('FE/PARTNER/upload/unggah_Foto KTP Pasangan'), 2)

WebUI.click(findTestObject('FE/PARTNER/upload/unggah_Foto KTP Pasangan'))
